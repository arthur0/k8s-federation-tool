...
* At this point, we have edited the **admin.conf** file to improve readability. We have manually renamed the contexts, clusters and users. You can do this by editing the file or ideally using kubectl. See `kubectl config --help`.
...
https://asciinema.org/a/07hn4d3lvnlczzozq7nnlx3sg
